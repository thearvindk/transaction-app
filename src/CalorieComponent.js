...
function CalorieComponent() {
    ...
    const fetchTotalCalories = async () => {
        try {
            const response = await axios.get('http://15.206.210.99:8090/Calories/total');
    ...
    const fetchCalorieData = async () => {
        try {
            const response = await axios.get('http://15.206.210.99:8090/Calories');
    ...
    const addCalorieData = async () => {
        try {
            const response = await axios.post('http://15.206.210.99:8090/Calories', {
                description,
