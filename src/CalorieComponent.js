...
function CalorieComponent() {
    ...
    const fetchTotalCalories = async () => {
        try {
            const response = await axios.get('http://localhost:8090/Calories/total');
    ...
    const fetchCalorieData = async () => {
        try {
            const response = await axios.get('http://localhost:8090/Calories');
    ...
    const addCalorieData = async () => {
        try {
            const response = await axios.post('http://localhost:8090/Calories', {
                description,
